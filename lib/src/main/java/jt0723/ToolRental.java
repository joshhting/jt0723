...
public class ToolRental {
    public String checkout(final Tool tool, final int days, final int discount, final LocalDate date) {
        if (days < 1) {
        ...
        return (new RentalAgreement(tool, days, discount, date)).toString();
    }
}
